...
const RoomDetails = (props: { params: Promise<{ slug: string }> }) => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR(slug ? `/api/roomDetail/${slug}` : null, fetchRoom);
  ...
  const calNumDays = () => {
    ...
    const timeDiff = (checkoutDate?.getTime() || 0) - (checkinDate?.getTime() || 0);
          ...
          <div className="md:col-span-8 md:w-full">
            <div>
              ...
              <div className="flex my-11">
                {room.offeredAmmenities.map((amenity) => (
                  <div
                    key={amenity._key}
                    className="md:w-44 w-fit text-center px-2 md:px-0 h-20 md:h-40 mr-3 bg-[#eff0f2] dark:bg-[#eff0f2] rounded-lg grid place-content-center"
                  >
              ...
              <div className="mb-11">
               ...
               <div className="mb-11">
               <h2 className="font-bold text-3xl mb-2">Safety And Hygine</h2>
               <div className="grid grid-cols-2">
